...
export class FloorsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('Quản Lý Khách Sạn - Vị Trí');
  ...
  getData(request?: any, isReset = false): void {
    ...
    this.floorsService.get(param).subscribe((data) => {
  ...
  confirm(id: any): void {
    this.isLoading = true;
    this.floorsService.delete(id).subscribe((result) => {
  ...
  openModal(data?: any): void {
    const modal = this.modal.create({
      ...
      nzContent: FloorsModalComponent,
