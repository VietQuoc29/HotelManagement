...
export class CustomersComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('Quản Lý Khách Sạn - Khách Hàng');
  ...
  getData(request?: any, isReset = false): void {
    ...
    this.customersService.get(param).subscribe((data) => {
  ...
  confirm(id: any): void {
    this.isLoading = true;
    this.customersService.delete(id).subscribe((result) => {
  ...
  openModal(data?: any): void {
    const modal = this.modal.create({
      ...
      nzContent: CustomersModalComponent,
